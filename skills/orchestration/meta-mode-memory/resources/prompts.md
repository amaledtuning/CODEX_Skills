...
- Internal/delegated artifacts are English-only unless explicitly user-facing in another language, explicitly including worker instructions, subagent visible status notes, reasoning summaries, intermediate messages, final outputs, handoff/bootstrap blocks, and delegated artifacts.
